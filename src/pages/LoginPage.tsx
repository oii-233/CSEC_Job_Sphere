...
import { Mail, Lock, Github, Apple, Facebook, Chrome } from 'lucide-react';
      ...
      <div className="hidden lg:flex flex-1 bg-gray-50 items-center justify-center p-12">
        ...
        >
          <div className="relative mb-8">
            ...
            <img
              src="https://picsum.photos/seed/login-illustration/600/600"
          ...
          <p className="text-gray-500">Log in to your account to continue your job search journey and track your applications.</p>
        </motion.div>
      </div>
